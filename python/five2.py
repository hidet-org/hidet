                    ...
                    while i < m_size:
                        ...
                        while jj < jb:
                            ...
                            while ii < ib:
                                ...
                                iidx = i + ii
                                # micro-kernel
                                c0_0to7 = avx_f32x8_load(~c[iidx, jj])

                                c1_0to7 = avx_f32x8_load(~c[iidx+1, jj])

                                c2_0to7 = avx_f32x8_load(~c[iidx+2, jj])

                                c3_0to7 = avx_f32x8_load(~c[iidx+3, jj])

                                for pp in range(pb):
                                    pi = p + pp
                                    bb_0to7 = avx_f32x8_load(~b[pi, jj])
                                ...
                                avx_f32x8_store(~c[iidx, jj], c0_0to7)
                                avx_f32x8_store(~c[iidx+1, jj], c1_0to7)
                                avx_f32x8_store(~c[iidx+2, jj], c2_0to7)
                                avx_f32x8_store(~c[iidx+3, jj], c3_0to7)
