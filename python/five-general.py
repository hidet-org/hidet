...
def ff():
    ...
    for m, n, k in [(1, 74, 1), (64, 64, 64), (110, 111, 111), (101, 101, 37), (111, 367, 369), (224, 562, 325), (256, 256, 256), (333, 444, 555), (512, 512, 512), (1024, 1024, 1024), (1024, 512, 768),
...
# 110 x 111 x 111: numpy takes  0.15 ms
# 101 x 37 x 101: hidet takes 0.05 ms
# 101 x 37 x 101: numpy takes  0.16 ms
# 111 x 369 x 367: hidet takes 0.57 ms
# 111 x 369 x 367: numpy takes  0.39 ms
# 224 x 325 x 562: hidet takes 1.38 ms
# 224 x 325 x 562: numpy takes  0.57 ms
# 256 x 256 x 256: hidet takes 0.59 ms
# 256 x 256 x 256: numpy takes  0.17 ms
# 333 x 555 x 444: hidet takes 2.77 ms
# 333 x 555 x 444: numpy takes  0.75 ms
# 512 x 512 x 512: hidet takes 4.43 ms
# 512 x 512 x 512: numpy takes  0.58 ms
# 1024 x 1024 x 1024: hidet takes 24.61 ms
# 1024 x 1024 x 1024: numpy takes  2.83 ms
# 1024 x 768 x 512: hidet takes 11.20 ms
# 1024 x 768 x 512: numpy takes  1.19 ms
# 480 x 480 x 480: hidet takes 3.77 ms
# 480 x 480 x 480: numpy takes  0.58 ms
# 720 x 720 x 720: hidet takes 10.64 ms
# 720 x 720 x 720: numpy takes  2.04 ms
# 720 x 1440 x 960: hidet takes 23.30 ms
# 720 x 1440 x 960: numpy takes  2.86 ms
# 1111 x 1111 x 1111: hidet takes 31.47 ms
# 1111 x 1111 x 1111: numpy takes  3.55 ms
# 1111 x 533 x 1314: hidet takes 18.68 ms
# 1111 x 533 x 1314: numpy takes  1.91 ms
