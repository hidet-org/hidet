...
from .definitions.compare import equal, less_than, greater_than, less_or_equal, greater_or_equal
from .definitions.reduce import reduce_mean, reduce_sum, reduce_var, reduce_min, reduce_max
