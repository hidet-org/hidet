...
class Conv2dGemmInverseMultiplyPattern(GraphPattern):
    def __init__(self):
...
class Conv2dGemmInverseAddPattern(GraphPattern):
    def __init__(self):
...
def conv2d_patterns() -> List[GraphPattern]:
    return [
        Conv2dGemmInverseMultiplyPattern(),
        Conv2dGemmInverseAddPattern()
    ]
