...
class CollectSymVarsAndFuncNames(IRRewriter):
    def __init__(self):
        super().__init__()
...
class FilterSymbolVar(IRRewriter):
...
class GenerateMagicVarsRewriter(IRRewriter):
    ...
    def visit_Function(self, func: Function):
        if is_launch_function(func):
            ...
            return Function(
                new_func.name, new_func.params, new_func.body, new_func.ret_type, new_func.kind, new_func.attrs
            )
        return func
