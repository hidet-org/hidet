...
class HIPInt32MathFunctionSet(MathFunctionSet):
    ...
    def min(self, a: Expr, b: Expr) -> Expr:
        return self.call('hip_i32_min', a, b)

    def max(self, a: Expr, b: Expr) -> Expr:
        return self.call('hip_i32_max', a, b)
...
hip_i32_math_function_set = HIPInt32MathFunctionSet()
hip_i32_math_function_set.register()
register_math_function_set('hip', 'int32', hip_i32_math_function_set)
