...
class HIPFloat32MathFunctionSet(MathFunctionSet):
    ...
    def call(name: str, *args) -> Expr:
        entry = primitive_func_pool.lookup_by_name('hip_f32_{}'.format(name))
...
hip_f32_math_function_set = HIPFloat32MathFunctionSet()
hip_f32_math_function_set.register()
register_math_function_set('hip', 'float32', hip_f32_math_function_set)
