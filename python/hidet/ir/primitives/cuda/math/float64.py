...
cuda_f64_math_function_set = CUDAFloat64MathFunctionSet()
cuda_f64_math_function_set.register()
register_math_function_set('cuda', 'float64', cuda_f64_math_function_set)
