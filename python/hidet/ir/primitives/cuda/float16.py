...
def register_primitive_functions_float16():
    ...
    register_unary_dialect_primitive_function(
        func_name='float16_htanh', generic_func=tanh, target_dtype='float16', dialect_dtype='float32'
    )
    register_unary_dialect_primitive_function(
        func_name='float16_herf', generic_func=erf, target_dtype='float16', dialect_dtype='float32'
    )
    register_binary_dialect_primitive_function(
        func_name='float16_hpow', generic_func=pow, target_dtype='float16', dialect_dtype='float32'
    )
