...
def register_primitive_functions_bfloat16():
    unary_names = ['__hneg', 'hsin', 'hcos', 'hexp', 'hrint', 'hfloor', 'hceil', 'hrsqrt', 'hsqrt']
    binary_names = ['__hmin', '__hmax']
    ternary_names = ['__hfma']
    base2bfloat16 = {
        'neg': '__hneg',
        'sin': 'hsin',
        'cos': 'hcos',
    ...
    register_unary_dialect_primitive_function(
        func_name='bfloat16_htanh', generic_func=tanh, target_dtype='bfloat16', dialect_dtype='float32'
    )
    register_unary_dialect_primitive_function(
        func_name='bfloat16_herf', generic_func=erf, target_dtype='bfloat16', dialect_dtype='float32'
    )
    register_binary_dialect_primitive_function(
        func_name='bfloat16_hpow', generic_func=pow, target_dtype='bfloat16', dialect_dtype='float32'
    )
