...
from .attention_mask import AttnMaskWhereOp, AttnMaskAddOp
...
class AttnOp(Operator):
    def __init__(self, q: Tensor, k: Tensor, v: Tensor):
        super().__init__(inputs=[q, k, v], task=AttnTask('attn', input_like(
            q, 'q'), input_like(k, 'k'), input_like(v, 'v')), attributes={})
