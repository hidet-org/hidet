...
class MatmulTask(Task):
    ...
    def implement_cuda(self) -> IRModule:
        from hidet.graph.ops.schedules.cuda.matmul import batched_matmul_cuda_schedule_simt, batched_matmul_cuda_schedule_wmma, batched_matmul_cuda_schedule_mma, batched_matmul_cuda_schedule_mma_fp16, batched_matmul_cuda_schedule_mma_fp16_pk
