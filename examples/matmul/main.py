...
from hidet.ir.dialects.compute import compute, TensorInput
...
# part of the following code is stale
# todo: update it
...
#     gmem_a_type = tensor_type(scope='global', dtype=dtype, layout=gmem_a_layout.slice_out([0]))
#     gmem_b_type = tensor_type(scope='global', dtype=dtype, layout=gmem_b_layout.slice_out([1]))
#     gmem_c_type = tensor_type(scope='global', dtype=dtype, layout=gmem_c_layout.slice_out([0, 2]))
#     smem_a_type = tensor_type(scope='shared', dtype=dtype, layout=smem_a_layout)
#     smem_b_type = tensor_type(scope='shared', dtype=dtype, layout=smem_b_layout)
#     regs_a_type = tensor_type(scope='register', dtype=dtype, layout=regs_a_layout)
#     regs_b_type = tensor_type(scope='register', dtype=dtype, layout=regs_b_layout)
#     regs_c_type = tensor_type(scope='register', dtype=dtype, layout=regs_c_layout)
#
#     # Define subtasks.
