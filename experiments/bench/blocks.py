...
def main():
    for executor in [
        ...
        '--exec hidet --precision f16 --reduce_precision f16 --hidet_space 2 --parallel_k disabled',
        '--exec hidet --precision f16 --reduce_precision f16 --hidet_space 2 --parallel_k default',
        '--exec hidet --precision f16 --reduce_precision f16 --hidet_space 2 --parallel_k search',
