...
from hidet.ir.cute.ops import tensor_view, partition_src, partition_dst, mask, copy, arithmetic, make_tensor
...
def test_mxn_1xn(memory_layout, tiled_copy, tiled_copy_r, dtype):
    ...
    with hidet.script_module() as script_module:
        ...
        def func(in_ptr: f16[block_m, block_n], r_ptr: f16[1, block_n], out_ptr: f16[block_m, block_n]):
            ...
            t_g_r = tensor_view(r_ptr, gmem_layout_r, "global")
            t_regs_r = make_tensor(dtype, tiled_tensor_layout_r, "register")
