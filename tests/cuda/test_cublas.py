...
def test_cublas_gemm(m, n, k, dtype, compute_type, tol):
    ...
    hidet.cuda.cublas.gemm(m, n, k, a.dtype, b.dtype, c.dtype, a, b, c, compute_type)
...
def test_cublas_strided_gemm(bs, m, n, k, dtype, compute_type, tol):
    ...
    hidet.cuda.cublas.strided_gemm(bs, m, n, k, a.dtype, b.dtype, c.dtype, a, b, c, m * k, k * n, m * n, compute_type)
    hidet.utils.assert_close(actual=c, expected=a @ b, rtol=tol, atol=tol)


def test_cublas_library_func():
